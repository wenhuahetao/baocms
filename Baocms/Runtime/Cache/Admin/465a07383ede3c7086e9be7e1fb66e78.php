...
<![endif]-->
    ...
    <body>
        ...
        <div class="main_logon">
            ...
            <p class="copy">技术支持：<?php echo ($CONFIG["site"]["title"]); ?>，此版本支持分站，分站登录地址:<a style="color:#f00" href="<?php echo ($CONFIG["site"]["host"]); ?>/fenzhan"><?php echo ($CONFIG["site"]["host"]); ?>/fenzhan </a></p>
        </div>		  	   	
