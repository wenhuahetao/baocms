...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            ...
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('usermoneylogs/index');?>">1：今日<a class="red"><?php echo ($counts['moneylogs']); ?></a>次资金流动</a></h3>
            <h3><a href="<?php echo U('usermoneylogs/index');?>">2：会员总资金<?php echo round($counts['money_and']/100,2);?>元</a></h3>
            <h3><a href="<?php echo U('usermoneylogs/index');?>">3：会员总积分<?php echo ($counts['money_integral']); ?>分</a></h3>
            <h3><a href="<?php echo U('usercash/index');?>">4：总提现<?php echo round($counts['money_cash']/100,2);?>元</a></h3>
            <h3><a href="<?php echo U('usercash/index');?>">5：提现成功<?php echo round($counts['money_cash_ok']/100,2);?>元</a></h3>
            <h3><a href="<?php echo U('usercash/index');?>">6：今日提现<a class="red"><?php echo round($counts['money_cash_day']/100,2);?></a>元，<a class="red"><?php echo ($counts['money_cash_audit']); ?></a>人待审</a></h3>
            </div>
    </div>
</div>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            ...
            <em>共<?php echo ($counts["shops"]); ?>个商家</em>
        </div>
            <div class="comiis_19forum_list">
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            ...
            <h3><a href="<?php echo U('uandianping/index');?>">5：团购共<?php echo ($counts["dianping_tuan"]); ?>条点评</a></h3>
            <h3><a href="<?php echo U('uandianping/index');?>">6：今日团购点评<a class="red"><?php echo ($counts["totay_dianping_tuan"]); ?></a>次</a></h3>
            </div>
    </div>
</div>
</li>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            <span class="comiis_19forum_icon"></span>
            <h2><a href="<?php echo U('shopdingyuyue/index');?>">订座数据</a></h2>
            <em>共有<?php echo ($counts["shop_ding"]); ?>个订座商家</em>
        </div>
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('shopdingyuyue/index');?>">1：共有<?php echo ($counts["shop_ding"]); ?>个订座商家</a></h3>
            <h3><a href="<?php echo U('shopdingyuyue/index');?>">2：共有<?php echo ($counts["shop_ding_room"]); ?>个包厢</a></h3>
            <h3><a href="<?php echo U('shopdingyuyue/index');?>">3：一共<?php echo ($counts["shop_ding_yuyue"]); ?>人预约，今日<a class="red"><?php echo ($counts["shop_ding_yuyue_day"]); ?></a>人预约订座</a></h3>
            <h3><a href="<?php echo U('dingdianping/index');?>">4：订座点评<?php echo ($counts["shop_ding_dianping"]); ?>笔</a></h3>
            <h3><a href="<?php echo U('dingdianping/index');?>">5：今日订座点评<a class="red"><?php echo ($counts["shop_ding_dianping_day"]); ?></a>笔</a></h3>
            </div>
    </div>
</div>
</li>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            <span class="comiis_19forum_icon"></span>
            <h2><a href="<?php echo U('delivery/index');?>">物流快递</a></h2>
            <em>共有<?php echo ($counts["delivery"]); ?>个配送员</em>
        </div>
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('delivery/index');?>">1：共有<?php echo ($counts["delivery_order"]); ?>单子</a></h3>
            <h3><a href="<?php echo U('delivery/index');?>">2：还有<?php echo ($counts["delivery_order_day_qiang"]); ?>单等待配送</a></h3>
            <h3><a href="<?php echo U('express/index');?>">3：今日配送中<a class="red"><?php echo ($counts["delivery_order_day_zhong"]); ?></a>单</a></h3>
            <h3><a href="<?php echo U('express/index');?>">4：今日配已完成<a class="red"><?php echo ($counts["delivery_order_day_ok"]); ?></a>单</a></h3>
            </div>
    </div>
</div>
</li>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            ...
            <h2><a href="#">点评数量</a></h2>
            <em>
            点：<?php echo ($counts["dianping"]); ?>
            商：<?php echo ($counts["dianping_goods"]); ?>
            团：<?php echo ($counts["dianping_tuan"]); ?>
            外：<?php echo ($counts["dianping_waimai"]); ?>
            </em>
        </div>
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('shopdianping/index');?>">1：今日商家点评<a class="red"><?php echo ($counts["totay_dianping"]); ?></a>次</a></h3>
            <h3><a href="<?php echo U('malldianping/index');?>">2：今日商城点评：<a class="red"><?php echo ($counts["totay_dianping_goods"]); ?></a>次</a></h3>
            <h3><a href="<?php echo U('tuandianping/index');?>">3：今日团购点评：<a class="red"><?php echo ($counts["totay_dianping_tuan"]); ?></a>次</a></h3>
            <h3><a href="<?php echo U('eledianping/index');?>">4：今日外卖点评：<a class="red"><?php echo ($counts["totay_dianping_waimai"]); ?></a>次</a></h3>
            <h3><a href="<?php echo U('dingdianping/index');?>">5：今日订座点评：<a class="red"><?php echo ($counts["shop_ding_dianping_day"]); ?></a>次</a></h3>
            </div>
    </div>
</div>
</li>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            <span class="comiis_19forum_icon"></span>
            <h2><a href="<?php echo U('post/index');?>">贴吧数据</a></h2>
            <em>总：<?php echo ($counts["post"]); ?>篇帖子</em>
        </div>
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('post/index');?>">1：今日新帖：<a class="red"><?php echo ($counts["totay_post"]); ?></a>篇</a></h3>
            <h3><a href="<?php echo U('post/index');?>">2：待审核帖子：<?php echo ($counts["post_audit"]); ?>篇</a></h3>
            <h3><a href="<?php echo U('post/index');?>">3：贴吧总回复：<?php echo ($counts["post_reply"]); ?>条,今日回复<a class="red"><?php echo ($counts["totay_post_reply"]); ?></a></a></h3>
            <h3><a href="<?php echo U('post/index');?>">4：待审核的总回复<?php echo ($counts["totay_post_reply_audit"]); ?>条</a></h3>
            </div>
    </div>
</div>
</li>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            <span class="comiis_19forum_icon"></span>
            <h2><a href="<?php echo U('village/index');?>">社区村镇</a></h2>
            <em>总<?php echo ($counts["village"]); ?>个社区</em>
        </div>
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('village/index');?>">1：共有社区<?php echo ($counts["village"]); ?>个。</a></h3>
            <h3><a href="<?php echo U('village/index');?>">2：共有村镇贴吧<?php echo ($counts["village_bbs"]); ?>个</a></h3>
            <h3><a href="<?php echo U('village/index');?>">3：共有村镇回复<?php echo ($counts["village_reply"]); ?>条</a></h3>
            <h3><a href="<?php echo U('village/index');?>">4：共有村镇意见反馈<?php echo ($counts["village_suggestion"]); ?>条</a></h3>
            <h3><a href="<?php echo U('village/index');?>">5：共<?php echo ($counts["villagejoin"]); ?>人加入村镇</a></h3>
            </div>
    </div>
</div>
</li>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            <span class="comiis_19forum_icon"></span>
            <h2><a href="<?php echo U('housework/index');?>">家政服务</a></h2>
            <em>总<?php echo ($counts["houseworksetting"]); ?>个家政</em>
        </div>
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('housework/index');?>">1：共有<?php echo ($counts["houseworksetting"]); ?>个家政。</a></h3>
            <h3><a href="<?php echo U('housework/index');?>">2：今日<a class="red"><?php echo ($counts["totay_jiazheng"]); ?></a>人预约</a></h3>
            <h3><a href="<?php echo U('housework/index');?>">3：需要确认预约<a class="red"><?php echo ($counts["totay_jiazheng_queren"]); ?></a>人</a></h3>
            <h3><a href="<?php echo U('housework/index');?>">4：家政点评<?php echo ($counts["lifeservice_dianping"]); ?></a></h3>
			<h3><a href="<?php echo U('housework/index');?>">5：今日家政点评<a class="red"><?php echo ($counts["totay_lifeservice_dianping"]); ?></a></a></h3>
            </div>
    </div>
</div>
</li>
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            <span class="comiis_19forum_icon"></span>
            <h2><a href="<?php echo U('bill/billorder');?>">网站缴费</a></h2>
            <em>总<?php echo ($counts["bill"]); ?>个缴费项目</em>
        </div>
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('bill/billorder');?>">1：共<?php echo ($counts["bill"]); ?>个缴费项目。</a></h3>
            <h3><a href="<?php echo U('bill/billorder');?>">2：今日缴费<a class="red"><?php echo ($counts["totay_bill"]); ?></a>条</a></h3>
            <h3><a href="<?php echo U('bill/billorder');?>">3：待审核<?php echo ($counts["totay_bill_audit"]); ?>条</a></h3>
            </div>
    </div>
</div>
</li>
