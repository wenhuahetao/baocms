        ...
        <div class="tableBox">
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                    ...
                    <?php if(($var["is_pei"]) == "1"): echo BA('shop/pei',array("shop_id"=>$var["shop_id"]),'开通配送','act','remberBtn_small');?>
                    <?php else: ?>
                      <?php echo BA('shop/pei',array("shop_id"=>$var["shop_id"]),'取消配送','act','remberBtn_small'); endif; ?> 

                    <?php if(($var["is_ding"]) == "1"): echo BA('shop/ding',array("shop_id"=>$var["shop_id"]),'取消订座','act','remberBtn_small');?>
                    <?php else: ?>
                      <?php echo BA('shop/ding',array("shop_id"=>$var["shop_id"]),'开通订座','act','remberBtn_small'); endif; ?>   
                    
                     <?php if(($var["is_biz"]) == "1"): echo BA('shop/biz',array("shop_id"=>$var["shop_id"]),'取消黄页','act','remberBtn_small');?>
                    <?php else: ?>
                      <?php echo BA('shop/biz',array("shop_id"=>$var["shop_id"]),'开通黄页','act','remberBtn_small'); endif; ?>                  
