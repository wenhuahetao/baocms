...
<div class="main-jsgl main-sc">
    <p class="attention" style="color:#F00; font-weight:bold;"><span>注意：</span>这个删除后商家数据就彻底删除了，请谨慎操作！删除后无法恢复！操作前必须备份数据库，否则后果自负！删除后会员就可以重新添加商家啦~</p>
    <div class="jsglNr">
    ...
    <form  target="baocms_frm" method="post">
        <div class="tableBox">
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                    ...
                    <?php echo BA('shop/recovery2',array("shop_id"=>$var["shop_id"]),'恢复','act','remberBtn');?>
                    <?php echo BA('shop/edit',array("shop_id"=>$var["shop_id"]),'编辑','','remberBtn');?>
                    <?php echo BA('shop/delete2',array("shop_id"=>$var["shop_id"]),'删除','act','remberBtn');?>
        ...
        <div class="selectNr" style="margin-bottom: 0px; border-bottom: none;">
            <div class="left">
                <?php echo BA('shop/delete2','','批量删除！必须备份数据库！','list',' a2');?>
                <?php echo BA('shop/recovery2','','批量恢复','list',' a1');?>
            </div>
        </div>
    </form>
</div>
