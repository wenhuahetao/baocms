...
<!-- 筛选TAB -->
<ul id="shangjia_tab">
        <li style="width: 25%;"><a href="<?php echo U('dianping/index');?>">商家点评</a></li>
        <li style="width: 25%;"><a href="<?php echo U('dianping/tuan');?>" class="on">抢购点评</a></li>
...
<div class="list-media-x" id="list-media">
	<ul>
      ...
      <?php if(empty($var['reply'])): ?><p class="text-right padding-top x6"> <a href="<?php echo U('dianping/tuanreply',array('order_id'=>$var['order_id']));?>" class="button button-small bg-dot">回复</a> </p>
      <?php else: ?>
