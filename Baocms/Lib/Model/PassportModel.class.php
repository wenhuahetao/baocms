...
class PassportModel {
    ...
    public function register($data = array()) {
        ...
        if ($fuser) {
            ...
            $profit_integral1 = (int)$this->_CONFIG['site']['profit_integral1'];
            $profit_integral2 = (int)$this->_CONFIG['site']['profit_integral2'];
            $profit_integral3 = (int)$this->_CONFIG['site']['profit_integral3'];
            $intro = '推荐用户注册奖励积分';
			$flag = false;
            if ($profit_integral1) {
